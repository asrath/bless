...
REMOTE_USERNAMES_AGAINST_IAM_GROUPS_OPTION = 'validate_remote_usernames_against_iam_groups'
REMOTE_USERNAMES_AGAINST_IAM_GROUPS_DEFAULT = "False"

IAM_GROUP_NAME_VALIDATION_FORMAT_OPTION = 'iam_group_name_format'
IAM_GROUP_NAME_VALIDATION_FORMAT_DEFAULT = 'ssh-{}'

FULL_ACCESS_IAM_GROUP_NAME_OPTION = 'full_access_iam_group'
FULL_ACCESS_IAM_GROUP_NAME_DEFAULT = 'disabled'
...
KMSAUTH_IAM_GROUP_NAME_VALIDATION_FORMAT_OPTION = 'kmsauth_iam_group_name_format'
KMSAUTH_IAM_GROUP_NAME_VALIDATION_FORMAT_DEFAULT = 'ssh-{}'
...
class BlessConfig(configparser.RawConfigParser, object):
    def __init__(self, aws_region, config_file):
        ...
        defaults = {CERTIFICATE_VALIDITY_BEFORE_SEC_OPTION: CERTIFICATE_VALIDITY_SEC_DEFAULT,
                    ...
                    KMSAUTH_IAM_GROUP_NAME_VALIDATION_FORMAT_OPTION: KMSAUTH_IAM_GROUP_NAME_VALIDATION_FORMAT_DEFAULT,
                    ...
                    REMOTE_USERNAMES_AGAINST_IAM_GROUPS_OPTION: REMOTE_USERNAMES_AGAINST_IAM_GROUPS_DEFAULT,
                    IAM_GROUP_NAME_VALIDATION_FORMAT_OPTION: IAM_GROUP_NAME_VALIDATION_FORMAT_DEFAULT,
                    FULL_ACCESS_IAM_GROUP_NAME_OPTION: FULL_ACCESS_IAM_GROUP_NAME_DEFAULT
                    }
