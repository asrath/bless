...
class BlessUserRequest:
    def __init__(self, bastion_user, public_key_to_sign, remote_usernames,
                 bastion_user_ip=None, bastion_ips=None, kmsauth_token=None):
        """
        ...
        :param bastion_ips: Optional source IPs where the SSH connection will be initiated from.  This is
