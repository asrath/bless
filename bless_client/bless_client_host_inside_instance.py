...
def main(argv):
    ...
    lambda_client = boto3.client('lambda', region_name=region, aws_access_key_id=creds.access_key, aws_secret_access_key=creds.secret_key, aws_session_token=creds.token)
